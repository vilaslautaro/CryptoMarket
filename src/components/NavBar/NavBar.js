            ...
            <header className='header'>
                <div className='header__Nav'>
                    ...
                    <ul className='nav__Menu'>
                        <NavLink className='menu__Enlaces' to={'/'}>
                            <li className='menu__Categorias'>Inicio</li>
                        </NavLink>
                        <NavLink className='menu__Enlaces' to={'/category/product'}>
                            <li className='menu__Categorias'>Productos</li>
                        </NavLink>
                        <NavLink className='menu__Enlaces' to={'/category/service'}>
